...
>- solve a **puzzle** to open the final room or disable CCTVs (cutting cables (add **electric spark** special effect))
...
>- **Shrink ray test**: we can also create scene where Dr Nefario successfully makes the shrink ray and Gru test it to the minion or stuffs.

## Scene 4: Asteroid Dodge

**Environment:** Black starfield with Earth visible in the distance. Asteroids and comets scroll in from the right; fuel canisters float between them.

Gru is now inside the rocket and claims that the Moon will be his. The rocket then flies through the asteroid belt. During the flight, asteroids come from the right at random heights, the rocket must dodge them. Fuel canisters will appear along the way, so the rocket can collect them so it won’t run out of fuel. Aside from asteriods, comets may also appear occasionally, though they are faster and move diagonally, so they are harder to dodge. Gru’s rocket may withstand up to 3 hits, after which it will be destroyed and the level restarts.

## Scene 5: Lunar Surface
...
**Environment:** An open clearing at the moon's centre, the full moon looming large against the starfield.

Gru arrives at the moon centre. He then hold up the Shrink Ray and says: “And now... the Moon is MINE!”. The player is required to hold SPACE in order to charge the Shrink Ray. Charge bar fills over 3 seconds. Upon reaching full charge, a brilliant green laser beams toward the moon. Gru finally catches the tiny moon in his hand. Agnes appears and says: “IT’S SO FLUFFY!”. An upbeat victory jingle rings out, accompanied by the final score and stats.
